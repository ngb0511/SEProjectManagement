...
const LecturerDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchApi = async () => {
      const result = await instructorServices.getInstructorbyID(id)
      const result1 = await projectServices.getProjectbyInstructor(id)
      setLecturer(result)
      setProject(result1)
    }
    fetchApi()
                ...
                <CCard>
                  <CCardBody>
                    ...
                    <p>
                      ...
                      {dateFormat(lecturer.birth, 'dd/mm/yyyy')}
                    </p>
                    <p>
