...
const CurrentProject = () => {
  ...
  const askQuestion = async () => {
    if (!question) {
      ...
      getMailData(student.sName, student.studentId, semester)
  ...
  const getMailData = (studentName, studentID, semester) => {
    ...
    mailData.EmailBody = '<p> Dear instructor ' + instructorName + ',</p>' + 
